# PsychoTest
This is a .NET Core Web application created for performing a psychological reserach which examined influence of using social media while doing repeatable tasks on computer. The application is written in .NET Core 3.1.
There is a similar desktop application of this resarch created and is on my GitHub profile - psychotest2.
